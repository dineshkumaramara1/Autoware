...
#ifndef VELODYNE_DECODER_H
#define VELODYNE_DECODER_H
...
#include <velodyne_msgs/VelodyneSweep.h>
...
public:
  ...
  VelodyneDecoder(ros::NodeHandle& n, ros::NodeHandle& pn);
  VelodyneDecoder(const VelodyneDecoder&) = delete;
  VelodyneDecoder operator=(const VelodyneDecoder&) = delete;
  ~VelodyneDecoder() {return;}

  bool initialize();
  typedef boost::shared_ptr<VelodyneDecoder> VelodyneDecoderPtr;
  typedef boost::shared_ptr<const VelodyneDecoder> VelodyneDecoderConstPtr;
...
private:
  ...
  void packetCallback(const velodyne_msgs::VelodynePacketConstPtr& msg);
  void daignosticUpdateCallback(const ros::TimerEvent& te);
  ...
  velodyne_msgs::VelodyneSweepPtr sweep_data;
...
typedef VelodyneDecoder::VelodyneDecoderPtr VelodyneDecoderPtr;
typedef VelodyneDecoder::VelodyneDecoderConstPtr VelodyneDecoderConstPtr;
